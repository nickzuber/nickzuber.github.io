  ...
  return (
    <Section id="about">
      <Container>
        ...
        <p>
          I'm Nick Zuber, a software engineer on the [secret] and <a href="https://robinpowered.com/features/">platform</a> teams at <a href="https://robinpowered.com">Robin</a>, helping modernize the open office. Previously, I interned at <a href="https://box.com/home">Box</a> as a tooling engineer where I helped work on <a href="https://www.clusterrunner.com">ClusterRunner</a>, which is an open source tool for horizontally optimizing tests & testing infrastructure.
        </p>
        <p>
